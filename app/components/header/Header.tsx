...
export default function Header() {
  ...
  // Tutup dropdown layanan kalau klik di luar header
  useEffect(() => {
      ...
      <div className="container">
        <div className={styles.inner}>
          ...
          <Link href="/" className={styles.logo} onClick={closeMenu}>
            <Image
              src="/images/logo-dif-logistics.png" // tetap sesuai perubahanmu
          ...
          <ul className={styles.mobileNavList}>
            ...
            <li className={styles.mobileNavItem}>
              <button
                ...
                className={
                  isServicesActive
                    ? `${styles.mobileDropdownToggle} ${styles.mobileNavLinkActive}`
